...
class login_page:
    def __init__(self, root):
        ...
        #self.bg_img = ImageTk.PhotoImage(file=r"C:\Users\Anusha\OneDrive\Desktop\TP\Images\photo1.jpeg")
        ...
        self.frame1.place(x=0, y=0, width=550, relheight = 1)

        label1 = Label(self.frame1, text= "Space", font=("times new roman", 40, "bold"), bg="yellow", fg="red").place(x=30,y=300)
        label2 = Label(self.frame1, text= "Invaders", font=("times new roman", 40, "bold"), bg="yellow", fg="RoyalBlue1").place(x=200,y=300)
        label3 = Label(self.frame1, text= "", font=("times new roman", 13, "bold"), bg="yellow", fg="brown4").place(x=100,y=360)

        #=============Entry Field & Buttons============

        self.frame2 = Frame(self.window, bg = "gray95")
        self.frame2.place(x=550,y=0,relwidth=1, relheight=1)

        self.frame3 = Frame(self.frame2, bg="white")
        self.frame3.place(x=150,y=150,width=500,height=450)
