...
class Face_Recognition:
    def __init__(self,root):
        ...
        img4=img4.resize((1630,890),Image.ANTIALIAS)
        self.photoimg4=ImageTk.PhotoImage(img4)

        bg_img=Label(self.root,image=self.photoimg4)
        bg_img.place(x=0,y=50,width=1630,height=890)

        img_top=Image.open(r"C:\Users\DELL\Downloads\Mini project\Mini project\Images\face.jpg")
        ...
        img_bottom=Image.open(r"C:\Users\DELL\Downloads\Mini project\Mini project\Images\face.jpg")
        img_bottom=img_bottom.resize((980,750),Image.ANTIALIAS)
    ...
    def mark_attendance(self,r,n,d):
        with open("C:\\Users\\DELL\\Downloads\\\Mini project\\\Mini project\\Attendance.csv","r+",newline="\n") as f:
            mydata=f.readlines()
            name_list=[]
            for line in mydata:
                entry=line.split((","))
    ...
    def face_recog(self):
        ...
        faceCascade=cv2.CascadeClassifier("C:\\python10\\Lib\\site-packages\\cv2\\data\\haarcascade_frontalface_default.xml")
