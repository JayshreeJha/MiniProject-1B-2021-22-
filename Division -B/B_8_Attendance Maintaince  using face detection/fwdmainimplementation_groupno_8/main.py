...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        # First Image
        img=Image.open(r"C:\Users\DELL\Downloads\Mini project\Mini project\Images\face_header_sd.jpg")
        ...
        #Third Image
        img3=Image.open(r"C:\Users\DELL\Downloads\Mini project\Mini project\Images\face_header_sd.jpg")
        ...
        #Student Button
        img5=Image.open(r"C:\Users\DELL\Downloads\Mini project\Mini project\Images\face.jpg")
        ...
        #Details section
        img6=Image.open(r"C:\Users\DELL\Downloads\Mini project\Mini project\Images\student-information.png")
        img6=img6.resize((250,170),Image.ANTIALIAS)
        self.photoimg6=ImageTk.PhotoImage(img6) 

        b1=Button(bg_img,image=self.photoimg6,command=self.student_details,cursor="hand2")
        b1.place(x=1100,y=90,width=220,height=200)
        ...
        b1_1.place(x=1100,y=270,width=220,height=30)
        #Attendance Section
        # img7=Image.open(r"C:\Users\DELL\Downloads\Mini project\Mini project\Images\attendance-speech-bubble-vector-24175572.jpg")
        ...
        #Train
        img9=Image.open(r"C:\Users\DELL\Downloads\Mini project\Mini project\Images\20104094.jpg")
        img9=img9.resize((500,230),Image.ANTIALIAS)
        self.photoimg9=ImageTk.PhotoImage(img9)

        b1=Button(bg_img,image=self.photoimg9,command=self.train_data,cursor="hand2")
        b1.place(x=630,y=90,width=220,height=200)

        b1_1=Button(bg_img,text="Train",command=self.train_data,cursor="hand2",font=("times new roman",15,"bold"),bg="black",fg="white")
        b1_1.place(x=630,y=270,width=220,height=30)

        img11=Image.open(r"C:\Users\DELL\Downloads\Mini project\Mini project\Images\240-2407002_customer-helpdesk-call-center-icon-vector.png")
        ...
        #
        # img12=Image.open(r"D:\Mini project\Images\Attendance.jpg")
        # img12=img12.resize((500,150),Image.ANTIALIAS)
        # self.photoimg12=ImageTk.PhotoImage(img12)

        # b1=Button(bg_img,image=self.photoimg12,cursor="hand2")
        # b1.place(x=1200,y=350,width=220,height=135)

        # b1_1=Button(bg_img,text="Attendance",cursor="hand2",font=("times new roman",15,"bold"),bg="black",fg="white")
        # b1_1.place(x=1200,y=470,width=220,height=30)
